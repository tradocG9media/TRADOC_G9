<%@ Page Language="C#" MasterPageFile="~/app_Masters/Child_page.master" AutoEventWireup="true" CodeFile="exclusive.aspx.cs" Inherits="Articles_Exclusive" %>

<%@ Register TagPrefix="ucRtCol" TagName="PageRtCol" Src="~/app_Inc-RtCols/ArticleArchive.ascx" %>

<asp:Content id="PageHeadTitle" ContentPlaceholderID="PageHeadTitle" runat="server">
	<title><%= ConfigurationSettings.AppSettings["Title_Prefix"] %>Exclusive Articles</title>
</asp:Content>



<asp:Content id="PageTitle" ContentPlaceholderID="PageTitle" runat="server">
	<div class="PageTitleBlock"><div class="PageTitle">Exclusive Articles</div></div>
</asp:Content>
...
<div>
	<asp:XmlDataSource ID="XmlArticleListExclusive"
				DataFile="~/app_Data/articles-complete.xml"
				XPath="/articles/complete[@id = 'exclusive']/article[frozen = '0' and archive = '0']/placement/.."
				runat="server">
	</asp:XmlDataSource>

	<asp:ListView ID="ItemList"
				DataSourceID="XmlArticleListExclusive"
		...
		<ItemTemplate>
			...
			<asp:HyperLink runat="server"
				NavigateUrl='<%# "~/app_Inc-Popup/photo-fullsize.aspx?photo=" + XPath("imageURL") %>'
				CssClass="std"
				rel="facebox" ><asp:Image runat="server"
					ImageUrl='<%# "~/app_Imgs-Article-Exclusive/" + XPath("imageURL") + "p.jpg" %>'
					AlternateText='<%# XPath("title") %>'
					CssClass="SiteLandPage" />
				<div class="blockenlarge" id="page"><asp:Image runat="server"
			...
			<p><%# XPath("pubDate") %><br />
			By: <%# XPath("author") %></p>
			<p><%# XPath("description") %>&nbsp; <asp:HyperLink runat="server"
				NavigateUrl='<%# XPath("link") %>'
				CssClass="std" >Read More</asp:HyperLink></p>
